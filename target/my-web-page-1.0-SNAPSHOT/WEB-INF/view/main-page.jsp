...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        <div class="row ml-5">
            <div class="col-md-12 col-lg-6 ">
                <h1>Jak to działa?</h1>
                <span class="badge badge-primary">1. Opcja</span><p>W formularzu wypełniasz odpowiednie pola wpisując podzespoły, które wybrałeś. Resztą zajmuję się ja. Zamawiam części z najlepszych sklepów za możliwiwe najniszą cenę. Składam komputer dokłądnie,dbając o cable-management. Następnie kontaktuję się z klientem w sprawie odbioru jednostki</p>
                <button type="button" class="btn btn-outline-primary">Wypełnij formularz</button>
                <br><br>
                <span class="badge badge-primary">2. Opcja</span><p> Możesz także napisać w wiadomości do jakich celów będzie używany komputer, czy masz obecnie jakieś podzespoły, które można użyć przy budowaniu jednostki oraz podajesz maksymalny budżet. Dalsze kroki są identyczne jak powyżej</p>
                <button type=button" href="#" class="btn btn-outline-primary">Wyślij wiadomość</button>
            </div>
            <div class="col-lg-6">
                <img class=img-fluid" class="rounded" src="http://www.naprawa-komputera.waw.pl/skladanie_komputera.jpg" alt="skl">
            </div>
    ...
    <div class="container-fluid text-cente">
        ...
        <div class="col-12 social">
            <a href="https://www.linkedin.com/in/kamila-nowak-7b267816b/"><i  class="fa fa-linkedin-square" style="font-size:50px; color:#2867B2"></i></a>
            <a href="https://github.com/KamilaNowak"><i class="fa fa-github" style="font-size:50px; color:black"></i></a>
            <a href="mailto:knowak242@gmail.com"><i  class="	far fa-address-card"style="font-size:50px;color:#D44638"></i></a>
        </div>
    </div>
</div>
<br>
