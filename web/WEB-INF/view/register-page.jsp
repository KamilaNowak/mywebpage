...
<div class="card bg-light" style="margin-left:600px; margin-right:600px; margin-bottom:20px; margin-top:20px">
    <article class="card-body mx-auto" style="max-width: 400px">
        ...
        <hr>
        <br>
        <form:form action="${pageContext.request.contextPath}/proceedRegisteration" method="post" class="form-horizontal" modelAttribute="validationUser">
           <c:if test="${fieldError!=null}">
            ...
            <div class="form-group input-group">
                <span class="input-group-text"><i class="fa fa-eye-slash"></i></span>
                <form:password path="confirmPassword" placeholder="confirm password" name="password" class="form-control"/>
            </div>
            <br>
            <div class="form-group input-group">
            ...
            <br>
            <button type="submit" id="registerButton" style="margin-left:290px" class="btn btn-outline-success">Zarejestruj</button>
            <a href ="${pageContext.request.contextPath}/login" class="btn btn-primary" style="margin-left:0px">Logowanie</a>
